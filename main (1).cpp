...
float Point::distance(Point a, Point b){ // метод расчитывает растояние между двумя точками
...
public:
    ...
    int N; //размер по Х
    int M; //размер по Y
    float initial_lengthX; //начальное растояние между точками по X
    float initial_lengthY; //начальное растояние между точками по Y
    //float initial_lengthZ; //начальное растояние между точками по Z
    float rigidity; // жесткость связи
